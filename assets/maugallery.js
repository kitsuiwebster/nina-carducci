(function($) {
  ...
  $.fn.mauGallery.listeners = function(options) {
    ...
    $(".gallery").on("click", ".mg-prev", function() { $.fn.mauGallery.methods.prevImage(options.lightboxId); });
    $(".gallery").on("click", ".mg-next", function() { $.fn.mauGallery.methods.nextImage(options.lightboxId); });
  ...
  $(".lightboxImage").attr("src", $(next).attr("src"));
    ...
    filterByTag() {
      ...
      $(this).addClass("active active-tag selected");
